...
import { IoCopy, IoClose, IoInformationCircle } from "react-icons/io5";
    ...
    const editableHTML = `
      ...
      <body>
        ...
        <script>
          ...
          function saveEdits() {
            const resumeContent = document.getElementById('resumeContent');
            // Save edited content back to localStorage
          ...
          window.addEventListener('beforeunload', function() {
            // Optional: Remove the stored content after a delay to allow for reloads
            setTimeout(() => {
